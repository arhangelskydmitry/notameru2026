...
@section('breadcrumbs')
    ...
    <span class="current">{{ $category->term->name }}</span>
@endsection
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const categoryId = postsContainer.dataset.category;
    ...
    async function loadMorePosts() {
        ...
        try {
            const response = await fetch(`/api/load-more-posts?offset=${offset}&limit=${limit}&category=${categoryId}`);
