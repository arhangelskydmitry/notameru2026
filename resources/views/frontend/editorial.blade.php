...
{!! json_encode([
    ...
    '@type' => 'ContactPage',
    'name' => 'Редакция и контакты',
    'description' => 'Контакты редакции сетевого издания «Нота Миру».',
    'url' => route('editorial'),
    'mainEntity' => [
        '@type' => 'Organization',
        ...
        'contactPoint' => [
            [
                ...
                'email' => 'pr@notame.ru',
                'telephone' => '+7 963 999-8-111',
            ],
            [
                '@type' => 'ContactPoint',
                'contactType' => 'technical support',
                'email' => 'notameru@yandex.ru',
            ],
        ],
    ],
...
<div style="max-width: 980px; margin: 0 auto; display: grid; gap: 24px;">
    ...
    <section style="background: #fff; padding: 32px 40px; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
        ...
        <div style="display: grid; gap: 14px; line-height: 1.7; color: #333;">
            ...
            <div><strong>Глубоков Сергей Николаевич</strong> — руководитель направления GR</div>
        </div>
    </section>
    ...
    <section style="background: #fff; padding: 32px 40px; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.08);">
        ...
        <div style="display: grid; gap: 12px; line-height: 1.8; color: #333;">
            ...
            <div><strong>Телефон:</strong> <a href="tel:+79639998111">+7 963 999-8-111</a></div>
            <div><strong>По редакционным вопросам:</strong> <a href="mailto:pr@notame.ru">pr@notame.ru</a></div>
