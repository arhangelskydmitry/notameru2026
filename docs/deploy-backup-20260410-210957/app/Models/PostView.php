...
class PostView extends Model
{
    ...
    public static function getTopPosts($period = 'week', $limit = 10)
    {
        try {
            ...
            return Cache::store('file')->remember($cacheKey, now()->addMinutes(10), function () use ($period, $limit) {
    ...
    public static function getViewStatistics($startDate, $endDate)
    {
        try {
            ...
            return Cache::store('file')->remember($cacheKey, now()->addMinutes(15), function () use ($start, $end) {
