...
class AdminPanelController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $visitorStats = \Cache::remember('admin_visitor_stats', 300, function() {
            return \App\Models\SiteVisitor::getTotalStatistics();
        });
        
        // Топ статей за неделю (кеш 10 мин)
        $topWeekPosts = \Cache::remember('admin_top_week_posts', 600, function() {
            return \App\Models\PostView::getTopPosts('week', 10);
        });
        
        // Топ статей за год (кеш 30 мин)
        $topYearPosts = \Cache::remember('admin_top_year_posts', 1800, function() {
            return \App\Models\PostView::getTopPosts('year', 10);
        });
        
        // Статистика просмотров за последние 30 дней (кеш 10 мин)
        $viewStatistics = \Cache::remember('admin_view_statistics_30d', 600, function() {
        ...
        // Статистика посетителей за последние 30 дней (кеш 10 мин)
        $dailyStatistics = \Cache::remember('admin_daily_statistics_30d', 600, function() {
    ...
    public function updateSeoSettings(Request $request)
    {
        ...
        try {
            ...
            \Illuminate\Support\Facades\Cache::forget('gigachat_access_token');
