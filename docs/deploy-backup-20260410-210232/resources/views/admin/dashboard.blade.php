...
@php
    ...
    // Get visitor data for the same period
    $visitorChartData = \App\Models\SiteVisitor::getDailyStatistics(
        now()->subDays(30)->toDateString(),
        now()->toDateString()
    );

    foreach ($visitorChartData as $visitor) {
        $chartVisitors[] = $visitor->visitors ?? 0;
    }
@endphp
