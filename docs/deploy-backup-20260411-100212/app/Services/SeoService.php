...
class SeoService
{
    ...
    protected function normalizeCanonicalPath(string $url, Post $post): string
    {
        ...
        $canonicalUrl = $scheme . '://' . $host . $slugPath;
    ...
    public function getOpenGraph(Post $post): array
    {
        ...
        return [
            ...
            'image' => $seo && $seo->og_image ? $this->fixDomainInUrl($seo->og_image) : $thumbnail,
    ...
    public function getTwitterCard(Post $post): array
    {
        ...
        return [
            ...
            'image' => $seo && $seo->twitter_image ? $this->fixDomainInUrl($seo->twitter_image) : $thumbnail,
        ];
    }
