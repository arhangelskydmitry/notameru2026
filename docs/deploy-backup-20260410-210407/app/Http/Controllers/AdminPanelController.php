...
class AdminPanelController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $topYearPosts = $cache->remember('admin_top_year_posts', now()->addMinutes(30), function() {
            return \App\Models\PostView::getTopPosts('year', 10);
        });
        
        // Статистика просмотров за последние 30 дней (кеш 10 мин)
        $viewStatistics = $cache->remember('admin_view_statistics_30d', now()->addMinutes(15), function() {
        ...
        $dailyStatistics = $cache->remember('admin_daily_statistics_30d', now()->addMinutes(15), function() {
