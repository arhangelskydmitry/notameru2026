...
class FrontendController extends Controller
{
    ...
    {
        // Asset-пути не должны проваливаться в catch-all и нагружать БД.
    ...
    public function htmlSitemap()
    {
        ...
        $years = Post::where('post_type', 'post')
            ->where('post_status', 'publish')
    ...
    {
        $months = Post::where('post_type', 'post')
            ->where('post_status', 'publish')
    ...
    {
        $days = Post::where('post_type', 'post')
            ->where('post_status', 'publish')
            ->whereYear('post_date', $year)
    ...
    public function postsByYear($year)
    {
        ...
        $postsCount = Post::where('post_type', 'post')
            ->where('post_status', 'publish')
            ->whereYear('post_date', $year)
            ->count();
